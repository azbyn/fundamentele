...
\label{sec:org5505554}
\subsection*{a)}
\label{sec:org2c2d013}
\begin{minted}[linenos,firstnumber=1,frame=single,escapeinside=||,mathescape=true]{cpp}
#include <iostream>
#include <cmath>
using namespace std;
...
\label{sec:orge8c92af}
\subsection*{Apartenenta}
\label{sec:orgc9d7a05}
\begin{minted}[linenos,firstnumber=1,frame=single,escapeinside=||,mathescape=true]{cpp}
#include <iostream>
...
\section*{Laborator 5}
\label{sec:orgfa5270d}
\subsection*{1. La o stație meteo \ldots{}.}
\label{sec:orgd14eb86}
\begin{minted}[linenos,firstnumber=1,frame=single,escapeinside=||,mathescape=true]{cpp}
#include <iostream>
using namespace std;
struct Zi {
...
\section*{Laborator 6}
\label{sec:orgcb33fb2}
\subsection*{5. Ackermann}
\label{sec:org170e2a5}
\begin{minted}[linenos,firstnumber=1,frame=single,escapeinside=||,mathescape=true]{cpp}
int A(int m, int n) {
    if (m == 0) {
        return n + 1;
...
\section*{Laborator 7}
\label{sec:orgfb48091}
\subsection*{2. Fibonacci}
\label{sec:org849e8aa}
\begin{minted}[linenos,firstnumber=1,frame=single,escapeinside=||,mathescape=true]{cpp}
#include <iostream>
#include <cmath>
using namespace std;
