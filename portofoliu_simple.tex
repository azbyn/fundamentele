...
\label{sec:org067c202}
\subsection*{a)}
\label{sec:org870baff}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
#include <iostream>
#include <cmath>
using namespace std;
...
\label{sec:orgfee7836}
\subsection*{Apartenenta}
\label{sec:orgbee7923}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
#include <iostream>
...
\section*{Laborator 5}
\label{sec:orgad6e5a4}
\subsection*{1. La o stație meteo \ldots{}.}
\label{sec:org5ed895c}
\begin{import}
...
\section*{Laborator 6}
\label{sec:org1c582b1}
\subsection*{5. Ackermann}
\label{sec:org2afe565}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
...
\section*{Laborator 7}
\label{sec:org25cdb7d}
\subsection*{2. Fibonacci}
\label{sec:org2c0131c}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
#include <iostream>
#include <cmath>
using namespace std;
...
\label{sec:org91d78bb}
\subsection*{1. Fibonacci}
\label{sec:org158a4f6}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
#include <iostream>
using namespace std;
