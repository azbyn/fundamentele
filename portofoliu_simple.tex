...
\label{sec:orgf9195e3}
\subsection*{a)}
\label{sec:orged23b54}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
#include <iostream>
#include <cmath>
using namespace std;
...
\label{sec:org37a15b4}
\subsection*{Apartenenta}
\label{sec:org2dfb36a}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
#include <iostream>
...
\section*{Laborator 6}
\label{sec:org3a915c6}
\subsection*{5. Ackermann}
\label{sec:org422b2db}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
...
\section*{Laborator 7}
\label{sec:org81003cb}
\subsection*{2. Fibonacci}
\label{sec:org227807a}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
#include <iostream>
#include <cmath>
using namespace std;
...
\label{sec:org17a40b6}
\subsection*{1. Fibonacci}
\label{sec:org271ea91}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
#include <iostream>
using namespace std;
