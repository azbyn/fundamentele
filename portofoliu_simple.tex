...
\label{sec:org1ea2a0b}
\subsection*{a)}
\label{sec:org1fa4f15}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
#include <iostream>
#include <cmath>
using namespace std;
...
\label{sec:orgf50e78b}
\subsection*{Apartenenta}
\label{sec:orgfb3a969}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
#include <iostream>
...
\section*{Laborator 5}
\label{sec:org7659d0d}
\subsection*{1. La o stație meteo \ldots{}.}
\label{sec:orga2e725c}
\begin{import}
...
\section*{Laborator 6}
\label{sec:org4d68ec4}
\subsection*{5. Ackermann}
\label{sec:org76629d9}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
...
\section*{Laborator 7}
\label{sec:orgc2bc536}
\subsection*{2. Fibonacci}
\label{sec:orgf8abb4f}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
#include <iostream>
#include <cmath>
using namespace std;
