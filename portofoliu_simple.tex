...
\label{sec:org6785220}
\subsection*{a)}
\label{sec:org2435622}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
#include <iostream>
#include <cmath>
using namespace std;
...
\label{sec:org79c4b89}
\subsection*{Apartenenta}
\label{sec:orgdf91226}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
#include <iostream>
...
\section*{Laborator 5}
\label{sec:org2bbaa58}
\subsection*{1. La o stație meteo \ldots{}.}
\label{sec:org2c41014}
\begin{import}
...
\section*{Laborator 6}
\label{sec:orgf391051}
\subsection*{5. Ackermann}
\label{sec:org5768fb5}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
...
\section*{Laborator 7}
\label{sec:org9de7ceb}
\subsection*{2. Fibonacci}
\label{sec:org74dfdd7}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
#include <iostream>
#include <cmath>
using namespace std;
...
\label{sec:orgd587d29}
\subsection*{1. Fibonacci}
\label{sec:org8328895}
\begin{minted}[linenos,firstnumber=1,frame=single,mathescape=true]{cpp}
#include <iostream>
using namespace std;
